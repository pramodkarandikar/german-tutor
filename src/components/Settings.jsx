...
const Settings = () => {
 ...
 <div className="flex items-center gap-6 mb-8 border-b-2 border-subtle pb-8">
 ...
 <div className="border-b-2 border-subtle pb-12">
 ...
 <button
 onClick={handleReset}
 className="inline-flex items-center gap-3 text-red-600 hover:text-red-700 hover:bg-red-50 :bg-red-900/10 px-6 py-3 rounded-full text-lg font-bold transition-all"
 >
