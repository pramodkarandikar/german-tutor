...
const MultipleChoice = () => {
 ...
 Read all options carefully before selecting. Eliminate obvious wrong answers first.
 </p>
 </div>
 </div>
 ...
 btnClass +="bg-red-500/10 text-red-600 border-red-500 border-[2px]";
 } else {
 btnClass +="bg-transparent border-text/5 text-text/30 cursor-not-allowed border-[2px] scale-[0.98]";
 }
 } else {
 btnClass +="bg-surface border-[2px] border-subtle text-text hover:border-text hover:shadow-xl :bg-white/5 cursor-pointer hover:-translate-y-1 shadow-sm";
 }
