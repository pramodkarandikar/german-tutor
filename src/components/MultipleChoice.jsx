                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto relative z-10">
                            {options.map((option, index) => {
                                ...
                                if (selectedOption) {
                                    ...
                                    btnClass += "bg-surface border-[2px] border-subtle text-text hover:border-text hover:shadow-xl dark:hover:bg-white/5 cursor-pointer hover:-translate-y-1 shadow-sm";
                                }
