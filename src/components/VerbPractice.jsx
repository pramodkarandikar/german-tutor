                    ...
                    {filteredVerbs.map((item, idx) => (
                        <div key={idx} className="bg-transparent border-[2px] border-subtle rounded-2xl p-6 hover:border-primary/50 hover:shadow-lg transition-all flex flex-col justify-between">
                            ...
                            <div className="pt-4 border-t-2 border-subtle">
                                ...
                                <span className="text-2xl font-bold text-primary dark:text-primary">{item['Past Participle']}</span>
                            </div>
                        </div>
                    ))}
            ...
            <div className="mb-6 text-center md:text-left relative z-10">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="flex-1">
                        <h1 className="text-4xl md:text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-primary via-primary/80 to-accent dark:from-primary dark:via-primary/80 dark:to-accent mb-3">Verbs Practice</h1>
                        ...
                        <div className="flex flex-col xl:flex-row items-start xl:items-center gap-4">
                            ...
                            {mode === 'practice' && (
                                <div className="flex flex-col gap-1 bg-primary/5 dark:bg-primary/5 px-4 py-2.5 rounded-2xl border border-primary/10 shadow-sm max-w-lg">
